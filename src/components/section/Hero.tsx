...
export default function Hero() {
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showToast && (
          <Toast message="Play promo clicked!" onClose={() => setShowToast(false)} />
        )}
      </AnimatePresence>
    </>
  )
...
function FloatingCard({
  ...
  return (
    <motion.div
      ...
      className={`absolute w-56 p-4 rounded-lg bg-white shadow-lg border border-gray-100 flex flex-col gap-2 select-none ${position}`}
...
function FloatingCardSmall({
  ...
  return (
    <div className="w-full p-4 rounded-lg bg-white shadow border border-gray-100 flex items-center gap-4 select-none">
      {icon}
      <div>
